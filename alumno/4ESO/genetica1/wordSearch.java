...
Font wordList=new Font ("Arial", Font.BOLD, 9);
Font fntLetters=new Font ("Arial",Font.BOLD,25);
...
grBuffer.drawString ("NUEVA BÚSQUEDA",560,40);
grBuffer.drawString ("RESOLVER",575,90);
...
grBuffer.setFont (new Font ("Arial", Font.BOLD, 13));
grBuffer.setColor (Color.yellow);
grBuffer.drawString ("Palabra seleccionada:",3,250);
